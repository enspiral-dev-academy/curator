...
Init.prototype = {
	initializeFolders: function (folders) {
		...
		var templateFile = path.resolve(this.templatePath, 'template.md');

		if (fs.existsSync(this.templatePath)) {
			// folder already there
			console.log('WARNING: ' + mainFolder + ' folder already exists inside ' + cwd + ' trying to create sub folders...');
			return fs.openAsync(templateFile, "wx+")
				.bind(this)
				.then(function () {
					console.log('SUCCESS: template.md added to ' + this.templatePath);
